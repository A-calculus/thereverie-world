...
- Name: smoke.spec.ts >> world detail surfaces render for demo world
- Location: tests/smoke.spec.ts:88:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://lvh.me:3000/apps/glitchwoods
Call log:
  - navigating to "http://lvh.me:3000/apps/glitchwoods", waiting until "load"
