...
- Name: smoke.spec.ts >> world wizard completes fallback deploy without crashing
- Location: tests/smoke.spec.ts:75:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://lvh.me:3000/apps/create
Call log:
  - navigating to "http://lvh.me:3000/apps/create", waiting until "load"
