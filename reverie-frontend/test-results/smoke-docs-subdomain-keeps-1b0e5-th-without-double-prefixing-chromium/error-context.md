...
- Name: smoke.spec.ts >> docs subdomain keeps explicit docs path without double prefixing
- Location: tests/smoke.spec.ts:46:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://docs.lvh.me:3000/docs/api-reference
Call log:
  - navigating to "http://docs.lvh.me:3000/docs/api-reference", waiting until "load"
