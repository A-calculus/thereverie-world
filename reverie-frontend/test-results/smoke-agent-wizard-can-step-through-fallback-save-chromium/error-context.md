...
- Name: smoke.spec.ts >> agent wizard can step through fallback save
- Location: tests/smoke.spec.ts:64:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://lvh.me:3000/agents/create
Call log:
  - navigating to "http://lvh.me:3000/agents/create", waiting until "load"
