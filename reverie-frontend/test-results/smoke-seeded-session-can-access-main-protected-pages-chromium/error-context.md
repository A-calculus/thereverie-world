...
- Name: smoke.spec.ts >> seeded session can access main protected pages
- Location: tests/smoke.spec.ts:55:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://lvh.me:3000/dashboard
Call log:
  - navigating to "http://lvh.me:3000/dashboard", waiting until "load"
